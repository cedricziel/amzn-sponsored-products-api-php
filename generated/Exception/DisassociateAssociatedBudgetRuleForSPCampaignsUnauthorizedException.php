...
class DisassociateAssociatedBudgetRuleForSPCampaignsUnauthorizedException extends UnauthorizedException
{
    /**
    ...
    {
        parent::__construct('Unauthorized. The request failed because user is not authenticated or is not allowed to invoke the operation.');
