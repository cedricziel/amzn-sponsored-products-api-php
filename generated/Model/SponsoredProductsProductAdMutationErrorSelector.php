...
class SponsoredProductsProductAdMutationErrorSelector extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var SponsoredProductsAsinOwnershipError
     */
    protected $asinOwnershipError;
    /**
     ...
     *
     * @var SponsoredProductsUnsupportedOperationError
     */
    protected $unsupportedOperationError;
    /**
     ...
     *
     * @var SponsoredProductsProductIdentifierError
     */
    protected $productIdentifierError;
    /**
     * Errors related to ad eligibility.
     *
     * @var SponsoredProductsAdEligibilityError
     */
    protected $adEligibilityError;
    /**
     ...
     * Errors related to author asin ownership.
     */
    public function getAsinOwnershipError(): SponsoredProductsAsinOwnershipError
    {
        return $this->asinOwnershipError;
    }

    /**
     * Errors related to author asin ownership.
     */
    public function setAsinOwnershipError(SponsoredProductsAsinOwnershipError $asinOwnershipError): self
    {
        $this->initialized['asinOwnershipError'] = true;
     ...
     * e.g. Seller are not supported to create custom text product ads.
     */
    public function getUnsupportedOperationError(): SponsoredProductsUnsupportedOperationError
    {
        return $this->unsupportedOperationError;
    }
     ...
     * e.g. Seller are not supported to create custom text product ads.
     */
    public function setUnsupportedOperationError(SponsoredProductsUnsupportedOperationError $unsupportedOperationError): self
    {
        $this->initialized['unsupportedOperationError'] = true;
     ...
     * Errors related to product identifiers.
     */
    public function getProductIdentifierError(): SponsoredProductsProductIdentifierError
    {
        return $this->productIdentifierError;
    }

    /**
     * Errors related to product identifiers.
     */
    public function setProductIdentifierError(SponsoredProductsProductIdentifierError $productIdentifierError): self
    {
        $this->initialized['productIdentifierError'] = true;
     ...
     * Errors related to ad eligibility.
     */
    public function getAdEligibilityError(): SponsoredProductsAdEligibilityError
    {
        return $this->adEligibilityError;
    }

    /**
     * Errors related to ad eligibility.
     */
    public function setAdEligibilityError(SponsoredProductsAdEligibilityError $adEligibilityError): self
    {
        $this->initialized['adEligibilityError'] = true;
