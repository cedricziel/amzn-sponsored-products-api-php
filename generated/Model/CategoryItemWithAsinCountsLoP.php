...
class CategoryItemWithAsinCountsLoP extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * @var string
     */
    protected $translatedCategoryPath;
    /**
     * @var IntegerRange
     */
     ...
     * The translated path of the category, which contains the current category and all parent categories.
     */
    public function getTranslatedCategoryPath(): string
    {
        return $this->translatedCategoryPath;
    }

    /**
     * The translated path of the category, which contains the current category and all parent categories.
     */
    public function setTranslatedCategoryPath(string $translatedCategoryPath): self
    {
        $this->initialized['translatedCategoryPath'] = true;
