...
class SponsoredProductsCampaignMutationErrorSelector extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var SponsoredProductsCurrencyError
     */
    protected $currencyError;
    /**
     * Errors related to bids.
     *
     ...
     * Errors related to currency.
     */
    public function getCurrencyError(): SponsoredProductsCurrencyError
    {
     ...
     * Errors related to currency.
     */
    public function setCurrencyError(SponsoredProductsCurrencyError $currencyError): self
    {
        $this->initialized['currencyError'] = true;
