...
class BidSuggestion extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The bid recommendation id.
     */
    public function getBidRecId(): string
    {
        return $this->bidRecId;
    }

    /**
     * The bid recommendation id.
     */
    public function setBidRecId(string $bidRecId): self
    {
        $this->initialized['bidRecId'] = true;
