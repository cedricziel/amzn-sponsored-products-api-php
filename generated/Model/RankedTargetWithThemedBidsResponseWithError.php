...
class RankedTargetWithThemedBidsResponseWithError extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The Error Response Object.
     */
    public function getError(): SPTargetingError
    {
        return $this->error;
    }
     ...
     * The Error Response Object.
     */
    public function setError(SPTargetingError $error): self
    {
