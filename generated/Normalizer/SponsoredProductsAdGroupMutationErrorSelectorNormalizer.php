...
class SponsoredProductsAdGroupMutationErrorSelectorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsAdGroupMutationErrorSelector::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsAdGroupMutationErrorSelector::class === get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsAdGroupMutationErrorSelector();
        ...
        if (\array_key_exists('applicableMarketplacesError', $data)) {
            $object->setApplicableMarketplacesError($this->denormalizer->denormalize($data['applicableMarketplacesError'], \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsApplicableMarketplacesError::class, 'json', $context));
            unset($data['applicableMarketplacesError']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('applicableMarketplacesError') && null !== $data->getApplicableMarketplacesError()) {
            $dataArray['applicableMarketplacesError'] = $this->normalizer->normalize($data->getApplicableMarketplacesError(), 'json', $context);
        }
    ...
    {
        return [\CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsAdGroupMutationErrorSelector::class => false];
    }
}
