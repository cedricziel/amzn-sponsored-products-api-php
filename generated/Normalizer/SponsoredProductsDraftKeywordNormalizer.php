...
class SponsoredProductsDraftKeywordNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('nativeLanguageDraftKeyword') && null !== $data->getNativeLanguageDraftKeyword()) {
            $dataArray['nativeLanguageDraftKeyword'] = $data->getNativeLanguageDraftKeyword();
        }
