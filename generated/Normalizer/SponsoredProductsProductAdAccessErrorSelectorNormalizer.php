...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SponsoredProductsProductAdAccessErrorSelectorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        {
            return \cedricziel\amznsponsoredproductsapiphp\Generated\Model\SponsoredProductsProductAdAccessErrorSelector::class === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return is_object($data) && cedricziel\amznsponsoredproductsapiphp\Generated\Model\SponsoredProductsProductAdAccessErrorSelector::class === get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \cedricziel\amznsponsoredproductsapiphp\Generated\Model\SponsoredProductsProductAdAccessErrorSelector();
        ...
        {
            return [\cedricziel\amznsponsoredproductsapiphp\Generated\Model\SponsoredProductsProductAdAccessErrorSelector::class => false];
        }
    }
} else {
    class SponsoredProductsProductAdAccessErrorSelectorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
