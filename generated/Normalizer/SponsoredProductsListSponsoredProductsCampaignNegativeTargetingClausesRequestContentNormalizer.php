...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SponsoredProductsListSponsoredProductsCampaignNegativeTargetingClausesRequestContentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('campaignNegativeTargetIdFilter') && null !== $object->getCampaignNegativeTargetIdFilter()) {
                $data['campaignNegativeTargetIdFilter'] = $this->normalizer->normalize($object->getCampaignNegativeTargetIdFilter(), 'json', $context);
            }
