...
if (!class_exists(Kernel::class) or (Kernel::MAJOR_VERSION >= 7 or Kernel::MAJOR_VERSION === 6 and Kernel::MINOR_VERSION === 4)) {
    class SponsoredProductsProductAdMutationErrorSelectorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        ...
        public function normalize(mixed $object, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
        {
            ...
            if ($object->isInitialized('asinOwnershipError') && null !== $object->getAsinOwnershipError()) {
                $data['asinOwnershipError'] = $this->normalizer->normalize($object->getAsinOwnershipError(), 'json', $context);
            }
            ...
            if ($object->isInitialized('unsupportedOperationError') && null !== $object->getUnsupportedOperationError()) {
                $data['unsupportedOperationError'] = $this->normalizer->normalize($object->getUnsupportedOperationError(), 'json', $context);
            }
            ...
            if ($object->isInitialized('productIdentifierError') && null !== $object->getProductIdentifierError()) {
                $data['productIdentifierError'] = $this->normalizer->normalize($object->getProductIdentifierError(), 'json', $context);
            }
            if ($object->isInitialized('adEligibilityError') && null !== $object->getAdEligibilityError()) {
                $data['adEligibilityError'] = $this->normalizer->normalize($object->getAdEligibilityError(), 'json', $context);
            }
