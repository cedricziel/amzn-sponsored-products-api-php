...
class SponsoredProductsProductAdMutationErrorSelectorNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsProductAdMutationErrorSelector::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsProductAdMutationErrorSelector::class === get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsProductAdMutationErrorSelector();
        ...
        if (\array_key_exists('asinOwnershipError', $data)) {
            $object->setAsinOwnershipError($this->denormalizer->denormalize($data['asinOwnershipError'], \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsAsinOwnershipError::class, 'json', $context));
            unset($data['asinOwnershipError']);
        }
        ...
        if (\array_key_exists('unsupportedOperationError', $data)) {
            $object->setUnsupportedOperationError($this->denormalizer->denormalize($data['unsupportedOperationError'], \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsUnsupportedOperationError::class, 'json', $context));
            unset($data['unsupportedOperationError']);
        }
        ...
        if (\array_key_exists('productIdentifierError', $data)) {
            $object->setProductIdentifierError($this->denormalizer->denormalize($data['productIdentifierError'], \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsProductIdentifierError::class, 'json', $context));
            unset($data['productIdentifierError']);
        }
        if (\array_key_exists('adEligibilityError', $data)) {
            $object->setAdEligibilityError($this->denormalizer->denormalize($data['adEligibilityError'], \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsAdEligibilityError::class, 'json', $context));
            unset($data['adEligibilityError']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('asinOwnershipError') && null !== $data->getAsinOwnershipError()) {
            $dataArray['asinOwnershipError'] = $this->normalizer->normalize($data->getAsinOwnershipError(), 'json', $context);
        }
        ...
        if ($data->isInitialized('unsupportedOperationError') && null !== $data->getUnsupportedOperationError()) {
            $dataArray['unsupportedOperationError'] = $this->normalizer->normalize($data->getUnsupportedOperationError(), 'json', $context);
        }
        if ($data->isInitialized('parentEntityError') && null !== $data->getParentEntityError()) {
            $dataArray['parentEntityError'] = $this->normalizer->normalize($data->getParentEntityError(), 'json', $context);
        }
        ...
        if ($data->isInitialized('productIdentifierError') && null !== $data->getProductIdentifierError()) {
            $dataArray['productIdentifierError'] = $this->normalizer->normalize($data->getProductIdentifierError(), 'json', $context);
        }
        if ($data->isInitialized('adEligibilityError') && null !== $data->getAdEligibilityError()) {
            $dataArray['adEligibilityError'] = $this->normalizer->normalize($data->getAdEligibilityError(), 'json', $context);
        }
    ...
    {
        return [\CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsProductAdMutationErrorSelector::class => false];
    }
}
