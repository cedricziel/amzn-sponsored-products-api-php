...
class SponsoredProductsListSponsoredProductsDraftCampaignNegativeKeywordsRequestContentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsListSponsoredProductsDraftCampaignNegativeKeywordsRequestContent::class === $type;
    }

    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsListSponsoredProductsDraftCampaignNegativeKeywordsRequestContent::class === get_class($data);
    }
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsListSponsoredProductsDraftCampaignNegativeKeywordsRequestContent();
        ...
        if (\array_key_exists('matchTypeFilter', $data)) {
            $object->setMatchTypeFilter($data['matchTypeFilter']);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('matchTypeFilter') && null !== $data->getMatchTypeFilter()) {
            $dataArray['matchTypeFilter'] = $data->getMatchTypeFilter();
        }
        foreach ($data as $key => $value) {
            if (preg_match('/.*/', (string) $key)) {
                $dataArray[$key] = $value;
    ...
    {
        return [\CedricZiel\AmznSponsoredProductsApiPHP\Generated\Model\SponsoredProductsListSponsoredProductsDraftCampaignNegativeKeywordsRequestContent::class => false];
    }
}
